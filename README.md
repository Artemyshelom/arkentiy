...
│   ├── Дорожная_карта...md      — roadmap
│   ├── BACKLOG.md               — что планируем
│   └── specs/                   — UX specs для TG-бота и веб
├── specs/
│   ├── tg/                      — Telegram UX (от @ux-бот)
│   │   ├── status_v2.md
│   │   ├── search_v2.md
│   │   └── tbank_reconciliation.md
│   └── web/                     — Веб UX (от @веб)
│       ├── cabinet.md
│       ├── landing.md
│       └── payment.md
...
| `docs/Дорожная_карта...md` | **PM** | Планы на квартал, фазы развития |
| `docs/BACKLOG.md` | **Разработчики** | Очередь задач (что не начинали) |
| `specs/` | **UX/Разработчики** | Макеты и требования перед кодом |
...
- [`99_Системное/Интегратор/Журнал.md`](../../99_Системное/Интегратор/Журнал.md) — что уже сделано по сессиям
