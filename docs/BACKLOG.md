...
- [x] `docs_cleanup` (P0) — ~~закрыть миграцию путей и убрать дубли в документации~~ ✅ 12.03.2026 (удалена .tz папка, jobs_health_dashboard → docs/specs/tg)
- [ ] `deploy_stability` (P0) — единый чеклист деплоя + контроль отката по инцидентам
- [x] `bf_hourly_t1` (P1) — ~~завершён~~ ✅ сессия 76
