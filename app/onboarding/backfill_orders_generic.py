...
Phase 1 — order-level (daily, resumable):
  Fills: delivery_num, branch_name, client_phone, sum, date, actual_time, delivery_address, etc.

Phases 2-5 — enrichment (weekly, parallel):
  Phase 2: items (DishName)
  Phase 3: courier (WaiterName)
  Phase 4: planned_time (Delivery.ExpectedTime)
  Phase 5: client_name (Delivery.CustomerName)
"""
